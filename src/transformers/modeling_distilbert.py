...
from transformers.file_utils import add_start_docstrings_to_callable, add_code_sample_docstrings, \
    replace_return_docstrings
from transformers.modeling_outputs import BaseModelOutput, MaskedLMOutput, SequenceClassifierOutput, \
    QuestionAnsweringModelOutput, TokenClassifierOutput, MultipleChoiceModelOutput
